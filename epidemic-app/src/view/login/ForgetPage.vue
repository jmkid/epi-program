<template>
  <div>
    <van-nav-bar left-arrow @click-left="_routerBack" title="找回密码" fixed :z-index="10"></van-nav-bar>
    <div class="nav-con align-center login-con"
      ...
      <div>
        ...
        <van-field v-model="password" left-icon="static/img/login/login_user.png" required clearable label="新密码"
